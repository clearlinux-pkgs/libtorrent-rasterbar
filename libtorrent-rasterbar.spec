...
Source0  : https://github.com/arvidn/libtorrent/releases/download/v2.0.8/libtorrent-rasterbar-2.0.8.tar.gz
...
%prep
%setup -q -n libtorrent-rasterbar-2.0.8
cd %{_builddir}/libtorrent-rasterbar-2.0.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666624062
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libtorrent-rasterbar.so.2.0.8
