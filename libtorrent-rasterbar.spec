...
Source0  : https://github.com/arvidn/libtorrent/releases/download/v2.0.11/libtorrent-rasterbar-2.0.11.tar.gz
...
%prep
%setup -q -n libtorrent-rasterbar-2.0.11
cd %{_builddir}/libtorrent-rasterbar-2.0.11
pushd ..
cp -a libtorrent-rasterbar-2.0.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738079003
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libtorrent-rasterbar.so.2.0.11
/usr/lib64/libtorrent-rasterbar.so.2.0
/usr/lib64/libtorrent-rasterbar.so.2.0.11
