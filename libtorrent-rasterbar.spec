...
Source0  : https://github.com/arvidn/libtorrent/releases/download/v2.0.6/libtorrent-rasterbar-2.0.6.tar.gz
...
%prep
%setup -q -n libtorrent-rasterbar-2.0.6
cd %{_builddir}/libtorrent-rasterbar-2.0.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650385764
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libtorrent-rasterbar-2.0.6/COPYING %{buildroot}/usr/share/package-licenses/libtorrent-rasterbar/bcb19528a41eea29d37cc740bb78a041314ecdb7
cp %{_builddir}/libtorrent-rasterbar-2.0.6/deps/asio-gnutls/LICENSE_1_0.txt %{buildroot}/usr/share/package-licenses/libtorrent-rasterbar/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
cp %{_builddir}/libtorrent-rasterbar-2.0.6/deps/try_signal/LICENSE %{buildroot}/usr/share/package-licenses/libtorrent-rasterbar/780a263c476ddbf4f51b12f82855201f7839a4a3
cp %{_builddir}/libtorrent-rasterbar-2.0.6/simulation/libsimulator/LICENSE %{buildroot}/usr/share/package-licenses/libtorrent-rasterbar/db0f086d1ffc769d49c9f98b18643a11c2fb7972
pushd clr-build
%make_install
popd
...
/usr/lib64/libtorrent-rasterbar.so.2.0.6
